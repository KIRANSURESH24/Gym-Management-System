...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="<?php if($page=='todo'){ echo 'active'; }?>"> <a href="to-do.php"><i class="icon icon-pencil"></i> <span>To-Do</span></a>
     ...
     <li class=""> <a href="store.php"><i class="icon icon-time"></i> <span>Supplementry Store</span></a>
...
<li><a href="https://wa.me/6282213673" target="_blank" class="float">

<i class="icon icon-bullhorn" aria-hidden="true"></i>Any Query's..?</a>
