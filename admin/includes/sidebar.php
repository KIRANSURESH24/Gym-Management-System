  ...
  <ul>
    ...
    <li class="<?php if($page=='attendance'){ echo 'submenu active'; } else { echo 'submenu';}?>"> <a href="#"><i class="fas fa-calendar-alt"></i> <span>Attendance</span></a>
      <ul>
       ...
       <li class="submenu"> <a href="#"><i class="fas fa-eye"></i> <span>Supplement Store</span></a>
      <ul>
        <li class=""><a href="../admin/add-product.php"><i class="fas fa-arrow-right"></i>Add Products</a></li>
          <li class=""><a href="../admin/product-list.php"><i class="fas fa-arrow-right"></i>Producr List</a></li>
        </ul>
      </li>
    ...
    <li class=""> <a href="purchase-list.php"><i class="fas fa-calendar-alt"></i> <span>Customer's Order</span></a>
