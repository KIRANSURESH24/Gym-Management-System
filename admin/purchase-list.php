        ...
        $result=mysqli_query($conn,$qry);
          ...
          echo"<table class='table table-bordered table-hover'>
            ...
            echo"<tbody> 
                ...
                <td><div class='text-center'>".$row['fname']."</div></td>
                <td><div class='text-center'>@".$row['lname']."</div></td>
                <td><div class='text-center'>".$row['address']."</div></td>
                <td><div class='text-center'>".$row['pincode']."</div></td>
                <td><div class='text-center'>".$row['dis']."</div></td>
                <td><div class='text-center'>".$row['city']."</div></td>
                <td><div class='text-center'>".$row['product']."</div></td>
